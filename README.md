...
5. [ConfigPortalParamsOnSwitch] (https://github.com/khoih-prog/ESP_WiFiManager/tree/master/examples/ConfigPortalParamsOnSwitch)  ***New to configure Portal Credentials***
