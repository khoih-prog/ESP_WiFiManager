...
5. [ConfigPortalParamsOnSwitch] (https://github.com/khoih-prog/ESP_WiFiManager/blob/master/examples/ConfigPortalParamsOnSwitch)  ***New to configure Portal Credentials***
